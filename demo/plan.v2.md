...
one-time sign-in link emailed to the user. Per review, passkeys are now an
explicit fast-follow (v1.1), not part of this v1.
...
```choice
id: rollout
prompt: How should we roll this out? (new — added after your review)
options:
  - Staff-only for a week, then general availability
  - 10% of users, ramping to 100% over a week
```
